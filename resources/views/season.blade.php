                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <span class="badge bg-red"> {{count($season) }} </span> <sub>Episodes</sub> 
                            </h2>
                                        ...
                                        @foreach ($season as $key=>$ep)
                                         ...
                                         <tr>
                                            ...
                                            <td> 
                                             @if ($ep->is_free==0)
                                             <p>
                                                <input name="" type="checkbox" id="{{$ep->videoid}}"/>
                                                <label for="{{$ep->videoid}}"></label>
                                              </p>
                                               @else
                                               <p>
                                                <input name="" type="checkbox" id="{{$ep->videoid}}" checked="checked" />
                                                <label for="{{$ep->videoid}}"></label>
                                              </p>
                                            ...
                                            <td>
                                                <input type="number" class="form-control" name="{{$ep->videoid}}" id="time-{{$ep->videoid}}" value="{{$ep->free_duration}}"> seconds 
                                                <button class="btn btn-primary m-3" id="btn-{{$ep->videoid}}" onclick="updateTime({{$ep->videoid}})">Update</button>
